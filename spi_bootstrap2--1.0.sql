...
RETURNS TABLE (l_suppkey int, l_quantity int, avg_l_partkey float4, avg_l_orderkey float4, avg_l_extendedprice float4, avg_l_discount float4, avg_l_linenumber float4) 
